...
var queryChaincode = async function(peer, channelName, chaincodeName, args, fcn, username, org_name) {
	let client = null;
	let channel = null;
	let response = { success: false, message: '', myMessage: '' };
	...
	try {
		...
		if (response_payloads) {
			...
			console.log('--------------------------payload', response_payloads.toString());
			response.success = true;
			response.message = 'successfully query the chaincode';
             response.myMessage =response_payloads[0].toString();
		} else {
